    ...
    private void CalculateCurrentPose()
    {
        ...
        else
        {
            ...
            CurrentPose = new PoseFrame
            {
                ...
                handRightPosition = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch) + rightHandRot * (new Vector3(translateX, translateY, translateZ)),
                handRightRotation = rightHandRot * Quaternion.AngleAxis(rotateDegrees, new Vector3(rotateXAxis, rotateYAxis, 1)),
