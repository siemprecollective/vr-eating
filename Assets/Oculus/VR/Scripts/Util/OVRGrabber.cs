...
public class OVRGrabber : MonoBehaviour
{
    ...
    public void ForceGrab(OVRGrabbable[] candidates)
    {
        if (candidates == null)
        {
            return;
        ...
        foreach (OVRGrabbable grabbable in candidates)
        {
    ...
    void OnUpdatedAnchors()
    {
        ...
        if (m_controller == OVRInput.Controller.RTouch)
        {
            ...
            handPos = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch) + rightHandRot * (new Vector3(translateX, translateY, translateZ));
            handRot = rightHandRot * Quaternion.AngleAxis(rotateDegrees, new Vector3(rotateXAxis, rotateYAxis, 1));
        }
